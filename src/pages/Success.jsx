...
const Proj = () => {
  ...
  // 🔹 Navigate to project tasks (Project Organizer)
  const goToProjectTasks = (projId) => {
    navigate(`/project-organizer/${projId}`);
  };
  ...
  return (
    <div>
        ...
        {projects.map((p, i) => (
          <AnimatedCard key={p._id || i} index={i}>
            <div className="flex flex-col justify-between h-full">
              ...
              <div
                onClick={() => goToProjectTasks(p._id)}
      ...
      {/* 🌌 Glassmorphic Modal (Add/Edit Project) */}
      <AnimatePresence>
        {showModal && (
          <motion.div
